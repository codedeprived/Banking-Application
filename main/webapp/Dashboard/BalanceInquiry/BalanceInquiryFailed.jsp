...
<h3 class="centerClass">Failed to fetch your balance from database. Please try again later.</h3>

<!-- <p>Click <a href = "Dashboard/Dashboard.jsp">here</a> to go back to dashboard.</p> -->
